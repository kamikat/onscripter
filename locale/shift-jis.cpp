...
{
	return ( x[0] == (unsigned char)0x81 && x[1] == (unsigned char)0x41 ||
          	x[0] == (unsigned char)0x81 && x[1] == (unsigned char)0x42 ||
          	x[0] == (unsigned char)0x81 && x[1] == (unsigned char)0x48 ||
          	x[0] == (unsigned char)0x81 && x[1] == (unsigned char)0x49 ||
          	x[0] == (unsigned char)0x81 && x[1] == (unsigned char)0x76 ||
          	x[0] == (unsigned char)0x81 && x[1] == (unsigned char)0x78 ||
          	x[0] == (unsigned char)0x81 && x[1] == (unsigned char)0x5b );	
}

int onsLocaleIsRotationRequired(const unsigned char *x)
{
	return ( !IS_TWO_BYTE(*x) ||
          	x[0] == (unsigned char)0x81 && x[1] == (unsigned char)0x50 ||
          	x[0] == (unsigned char)0x81 && x[1] == (unsigned char)0x51 ||
          	x[0] == (unsigned char)0x81 && x[1] >= 0x5b && x[1] <= 0x5d ||
          	x[0] == (unsigned char)0x81 && x[1] >= 0x60 && x[1] <= 0x64 ||
          	x[0] == (unsigned char)0x81 && x[1] >= 0x69 && x[1] <= 0x7a ||
          	x[0] == (unsigned char)0x81 && x[1] == (unsigned char)0x80 );
}

int onsLocaleIsTranslationRequired(const unsigned char *x)
{
	return ( x[0] == (unsigned char)0x81 && x[1] >= 0x41 && x[1] <= 0x44 );	
}
